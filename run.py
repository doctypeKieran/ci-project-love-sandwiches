...
"""
The following two functions are commented out.
They were refactored into one function which accepts the incoming data and the worksheet
name as arguments.
"""
...
#     """
#     Update surplus worksheet, add new row with calculated surplus based on stock and sales data.
#     """
...
def get_stock_values(data):
    ...
    return {heading:val for (heading, val) in zip(headings, data)}
